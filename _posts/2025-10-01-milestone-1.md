...
The next step is to build an interactive tool to help us explore and understand NHL play-by-play data. It looks like a custom dashboard that allows to dig into the specifics of any game.
...
![Figure 4.1](assets/images/sample_one.png)

![Figure 4.1](assets/images/sample_two.png)
...
This figure was generated using our NHL data processing pipeline and shows:
