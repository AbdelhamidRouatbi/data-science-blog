...
We created the features from all the questions (including bonus power-play features). We also added another feature, player_count_diff, which is the difference between friendly_player_count and opponent_player_count.
