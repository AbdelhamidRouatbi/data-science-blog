...
**Protocol.** We froze the models and hyper-parameters from earlier parts and evaluated on the untouched **2020/21 regular-season test split**. For each figure we plotted **five curves**: the three LR baselines from Q3, our **Q6 final CatBoost (Platt-calibrated)**, and a random baseline for reference.
...
{% include milestone2/q7_test_roc_core4.html width="700" %}
...
{% include milestone2/q7_test_goalrate_core4.html width="700" %}
...
{% include milestone2/q7_test_cum_goals_core4.html width="700" %}
...
{% include milestone2/q7_test_calibration_core4.html width="700" %}
...
**Takeaways.** The ordering is consistent with validation but **test performance is higher** (CatBoost AUC ~0.872 vs ~0.858 previously), likely thanks to the data fix your teammate pushed. CatBoost’s probabilities are both sharp and well-calibrated, which matters for xG usage; the LR baselines provide a useful sanity check but are clearly limited.

---

## Q7.2 — Playoff games (to be filled after running)

**Figure placeholders (playoffs):**
